...
// HP company logo SVG (wrapped in div — SVGElement is not instanceof HTMLElement, div is)
const HP_LOGO = (
  <div slot="logo" style={{ display: 'flex', alignItems: 'center', height: '36px' }}>
    <svg width="52" height="36" viewBox="0 0 1571 1074" xmlns="http://www.w3.org/2000/svg">
